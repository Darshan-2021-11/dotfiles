...
static const char *fonts[]          = { "FreeMono:style=Medium:pixelsize=18:antialias=true:autohint=true" };
static const char dmenufont[]       = "FreeMono:style=Medium:pixelsize=18:antialias=true:autohint=true";

static const char col_norm_font[]   = "#ffffff";
static const char col_norm_bg[]     = "#000000";
static const char col_norm_border[] = "#888888";
static const char col_sel_font[]    = "#ffffff";
static const char col_sel_bg[]      = "#241f31";
static const char col_sel_border[]  = "#8800ff";
static const char *colors[][3]      = {
	/*               fg             bg           border   */
	[SchemeNorm] = { col_norm_font, col_norm_bg, col_norm_border }, /* Norm: Inactive tabs and windows */
	[SchemeSel]  = { col_sel_font,  col_sel_bg,  col_sel_border  }, /* Sel :   Acitve tabs and windows */
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_norm_bg, "-nf", col_norm_font, "-sb", col_sel_bg, "-sf", col_sel_font, NULL };
